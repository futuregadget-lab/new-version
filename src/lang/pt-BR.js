export default {
  ...
  homePage: {
    divergenceMeter: {
      title: 'Medidor de Divergência',
      description: 'Veja o número de divergência em tempo real.'
    },
  ...
  gadgetsPage: {
    ...
    gadgets: [
      {
        ...
        specialPrice: true,
        description: `
          Big Things that you can experience the optical camouflage artificially. 
    ...
    shop: {
      cart: 'Carrinho',
      shoppingCart: 'Carrinho de compras',
      cartEmpty: 'Seu carrinho de compras está vazio.',
      fromFor: 'De {0} por:',
      addToCart: 'Adicionar ao carrinho',
      preOrder: 'Pré-venda',
      preOrderAddToCart: 'Pré-venda: adicionar ao carrinho',
      acceptingReservations: 'Disponível para pré-venda.',
      viewDetails: 'Ver detalhes',
      proceedToCheckout: 'Continuar',
      order: 'Pedido',
      item: 'nenhum item | 1 item | {count} itens',
      subtotal: 'Subtotal ({number})',
      price: 'Preço',
      referencePrice: 'Preço sugerido',
      off: 'Você economiza',
      offPrice: '{price} ({percent}%)',
      quantity: 'Quantidade',
      shop: 'Loja',
      delete: 'Excluir',
      removedFromCart: '{0} foi removido do carrinho de compras.',
      inStock: 'Em estoque',
      productDetails: 'Detalhes do produto',
      customersAlsoBought: 'Clientes que compraram este item também compraram',
      addedToCart: 'Adicionado ao carrinho',
      cartSubtotal: 'Subtotal do carrinho',
      containsGift: 'Este pedido contém um presente',
      filterBy: 'Filtrar por',
      stockAvailability: 'Estoque',
